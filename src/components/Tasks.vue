                   ...
                   <div class="flex flex-row items-center justify-between">
                        <div>
                            <div class="flex flex-row items-center">
                                ...
                                <div :class="store.completedItems.find(itm => itm == element.main) ? 'strike' : ''" class="ml-2 wrap-break-word max-w-32 sm:max-w-48 lg:max-w-[100%] flex-grow"> {{ element.main }}</div>
                            </div>

                            <div class="mt-1 wrap-break-word flex-grow">
