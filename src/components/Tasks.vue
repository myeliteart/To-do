                   ...
                   <div class="flex flex-row items-center justify-between">
                        <div>
                            <div class="flex flex-row items-center">
                                ...
                                <div :class="store.completedItems.find(itm => itm == element.main) ? 'strike' : ''" class="ml-2 wrap-break-word w-32 sm:w-48 lg:w-[630px] flex-grow"> {{ element.main }}</div>
                            </div>

                            <div class="mt-1 wrap-break-word flex-grow w-32 sm:w-48 lg:w-[630px]">
                        ...
                        <div class="ml-9 flex flex-row items-center">
                            ...
                            <font-awesome-icon  @mouseover="store.isHovered = true" @mouseleave="store.isHovered = false" :icon="['fas', 'grip-vertical']" class="ml-5" :class="{'draggable-active': store.isHovered}"></font-awesome-icon>
                        </div>
                 </div>
            </div>
         </div>
