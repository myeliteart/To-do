               ...
               <div class="py-4">
                   <div class="flex flex-row items-center justify-between">
                        ...
                        <div class="ml-9 flex flex-row items-center">
                            ...
                            <font-awesome-icon  @mouseover="store.isHovered = true" @mouseleave="store.isHovered = false" :icon="['fas', 'grip-vertical']" class="ml-0 sm:ml-5 hidden md:block" :class="{'draggable-active': store.isHovered}"></font-awesome-icon>
                        </div>
                 </div>
            </div>
         </div>
