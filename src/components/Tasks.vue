                   ...
                   <div class="flex flex-row items-center justify-between">
                        <div>
                            <div class="flex flex-row items-center">
                                ...
                                <div :class="store.completedItems.find(itm => itm == element.main) ? 'strike' : ''" class="ml-2 wrap-break-word max-w-40 sm:max-w-64 lg:max-w-[100%] flex-grow"> {{ element.main }}</div>
                            </div>
